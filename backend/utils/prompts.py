...
GOAL  
Return a structured list of 3 high-impact entities to serve as nodes for a graph around {target}. This graph will later be used to trace reaction chains and measure event impacts.  
